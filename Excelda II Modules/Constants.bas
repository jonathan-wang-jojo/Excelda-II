...
Public Const MIN_LINK_SPEED As Double = 4#
Public Const MAX_LINK_SPEED As Double = 60#
Public Const LINK_SPEED_MULTIPLIER As Double = 2.6
Public Const LINK_ANIM_FRAME_SECONDS As Double = 1# / 30#
Public Const LINK_STEP_FRAME_DISTANCE As Double = 0#
Public Const INPUT_BUFFER_SECONDS As Double = 0.12
